local Maroky = Instance.new("ScreenGui")
...
Maroky.Name = "Maroky"
Maroky.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
Maroky.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
Maroky.ResetOnSpawn = false
...
local function CRQZX_fake_script() -- ExecuteIY.LocalScript 
	...
	GetScriptIY.MouseButton1Click:Connect(function()
		loadstring(game:HttpGet("https://raw.githubusercontent.com/huybuda1/Invincible-Hub-Premium-Star/main/Invincible%20Hub%20Prem.lua"))()
	end)
end
...
local function ZIJP_fake_script() -- ExecuteZekroV2.LocalScript 
	...
	GetScriptIY.MouseButton1Click:Connect(function()
          loadstring(game:HttpGet("https://raw.githubusercontent.com/DNHA05/Invincible/main/Maroky%20Hub.lua"))()
	end)
end
